...
nlohmann::json SerializePropertyValue(const storage::PropertyValue &property_value) {
  ...
  switch (property_value.type()) {
    ...
    case Type::TimeSpan: {
      ...
      auto data = nlohmann::json::object();
      data.emplace("vt-first", timespan_data.first.first.get_microseconds());
      data.emplace("vt-second", timespan_data.first.first.get_microseconds());
      data.emplace("value", SerializePropertyValue(*timespan_data.second));
      return data;
    }
